import { Box, Button, Card, CardBody, Grid, GridItem, HStack, Image, Input, Stack, Text } from '@chakra-ui/react';
        ...
        <Grid templateColumns="repeat(16, 1fr)" gap={6}>
          <GridItem colSpan={2}>
            <Image
              src={featureImage}
              alt={title}
              className="w-full aspect-square object-contain bg-gray-200 rounded-sm"
            />
          </GridItem>
